...
namespace UserModule_EPSON_EB_1880_V1_0_PROCESSOR
{
    public class UserModuleClass_EPSON_EB_1880_V1_0_PROCESSOR : SplusObject
    {
    ...
    public UserModuleClass_EPSON_EB_1880_V1_0_PROCESSOR ( string InstanceName, string ReferenceID, Crestron.Logos.SplusObjects.CrestronStringEncoding nEncodingType ) : base( InstanceName, ReferenceID, nEncodingType ) {}
