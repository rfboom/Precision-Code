...
namespace UserModule_YAMAHA_VOLUME_PROC
{
    public class UserModuleClass_YAMAHA_VOLUME_PROC : SplusObject
    {
        ...
        object SEND_STRING_OnPush_0 ( Object __EventInfo__ )
            ...
            try
            {
                ...
                MakeString ( MODULE_TXD__DOLLAR__ , "set MTX:mem_512\u002F{0}\u002F{1}\u002F{2}\u002F{3}\u002F{4}\u002F{5} 0 0 {6}\u000A", Functions.ItoA (  (int) ( IINSTANCE ) ) , SPAR1 , SPAR2 , SPAR3 , SPAR4 , SPAR5 , SCONTROLVAL ) ; 
                ...
                if ( Functions.TestForTrue  ( ( Functions.BoolToInt ( Functions.Find( "Send Name\u000A" , TEMP1 ) > 0 ))  ) ) 
                    ...
                    if ( Functions.TestForTrue  ( ( Functions.BoolToInt (INOTTEXTER == 0))  ) ) 
                        ...
                        if ( Functions.TestForTrue  ( ( Functions.Find( "-" , TEMP1 ))  ) ) 
                            ...
                            if ( Functions.TestForTrue  ( ( Functions.BoolToInt ( Functions.Atoi( TEMP1 ) > 5000 ))  ) ) 
                                { 
                                ...
                                IVOLDOWNCALC = (ushort) ( (5000 - Functions.Atoi( TEMP1 )) ) ; 
...
object CONTROL_VALUE_OnChange_9 ( Object __EventInfo__ )
    ...
    try
    {
        ...
        SCONTROLVAL  .UpdateValue ( CONTROL_VALUE  ) ; 
...
public override void LogosSplusInitialize()
{
    ...
    SCONTROLVAL  = new CrestronString( Crestron.Logos.SplusObjects.CrestronStringEncoding.eEncodingASCII, 3, this );
...
public UserModuleClass_YAMAHA_VOLUME_PROC ( string InstanceName, string ReferenceID, Crestron.Logos.SplusObjects.CrestronStringEncoding nEncodingType ) : base( InstanceName, ReferenceID, nEncodingType ) {}
